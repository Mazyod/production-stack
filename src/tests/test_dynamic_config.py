...
FORK_STARTUP_ONLY_FLAGS = {
    ...
    "structured_output_repair_max_bytes": 2097152,
    "structured_output_repair_max_seconds": 45.0,
    "structured_output_repair_capture_dir": "/var/run/router-capture",
    "structured_output_repair_capture_sample_rate": 0.05,
    "structured_output_repair_capture_max_bytes": 8192,
    "structured_output_repair_capture_retention_days": 14,
}
